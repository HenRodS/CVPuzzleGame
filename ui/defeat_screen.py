...
def tela_derrota_pygame(tela, largura_tela, cursor, click):
    """
    Renderiza a tela de derrota quando o tempo do jogador se esgota.
    Retorna:
    ...
    fonte_sub = pygame.font.SysFont("Arial", 26)
