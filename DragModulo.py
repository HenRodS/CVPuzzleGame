...
class DragImg():
    def __init__(self, path, pathTarget, posOrigin, posTarget, width=200, height=200):
        ...
        self.imgTarget = pygame.image.load(self.pathTarget).convert_alpha()

        # 2. Redimensiona 
        self.img = pygame.transform.smoothscale(self.img, (width, height))
        self.imgTarget = pygame.transform.smoothscale(self.imgTarget, (width + 10, height + 10))
        ...
        self.rect = self.img.get_rect(topleft=self.posOrigin)
